package com.ktr.ktrsupportlibrary.common.setting;


import com.ktr.ktrsupportlibrary.common.SupportLibraryApp;
import com.ktr.ktrsupportlibrary.utils.ActivityHelper;
import com.ktr.ktrsupportlibrary.utils.SdcardUtils;
...
//            File rootFile = new File(SupportLibraryApp.getInstance().getAppPath());
	...
	public static void addSettings(String settingsXmlName) {
		Map<String, Setting> newSettingMap = SettingsXmlParser.parseSettings(SupportLibraryApp.getInstance(), settingsXmlName);
