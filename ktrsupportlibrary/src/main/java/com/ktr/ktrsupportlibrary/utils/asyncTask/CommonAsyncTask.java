package com.ktr.ktrsupportlibrary.utils.asyncTask;
...
public abstract class CommonAsyncTask<Params, Progress, Result> {
     ...
     *                               {@link AsyncTask.Status#RUNNING} or {@link AsyncTask.Status#FINISHED}.
     */
    public final CommonAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
                                                                             Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        ...
        AsyncTaskResult(CommonAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
